...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdCargar.Location = New System.Drawing.Point(216, 9)
        ...
        For i = 0 To strNumeros.Length - 1
            ...
            Try
                ...
                If conteo = 0 Then
                    ...
                    cmd.ExecuteNonQuery()
                Else
                    cmd.CommandText = "UPDATE suscripciones_participantes SET cantidad=cantidad+1, notificado=0, fecha=NOW() WHERE idSuscripcion=" & suscripcion & " AND numero=" & strNumeros(i)
                    cmd.ExecuteNonQuery()
                End If
            Catch ex As MySqlException
                trans.Rollback()
                MsgBox("Error! No se pudo ingresar el item " & i + 1 & ": " & strNumeros(i), MsgBoxStyle.SystemModal)
            End Try
        Next
        Try
            trans.Commit()
