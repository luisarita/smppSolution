...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "consRifas"
        Me.pTitle = "Consultar Telechats"
        Me.Text = "Consultar Telechats"
...
#End Region
    ...
    Private Sub dgDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgDatos.DoubleClick
        ...
        Dim a As New agrTelechat(row("id"))
        a.Owner = Me
    ...
    Private Sub cmdEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEliminar.Click
        If MsgBox("¿Seguro que desea eliminar esta rifa?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            Dim row As DataRow = row_actual(dgDatos)
            If row Is Nothing Then
                MsgBox("Seleccione una telechat")
                Exit Sub
            End If
            If CNX.State <> ConnectionState.Open Then CNX.Open()
            Using deleteCMD As New MySqlCommand("DELETE FROM telechats WHERE id=" & row("id"), CNX)
                Try
