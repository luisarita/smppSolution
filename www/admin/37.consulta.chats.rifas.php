...
if (isset($_POST['desde']) && isset($_POST['hasta']) && isset($_POST['idRifa'])) {
...
$res_datos = mysql_query("SELECT id, nombre FROM rifas WHERE estado=1 ORDER BY nombre", $conexion) or die(register_mysql_error("CRC002", mysql_error()));
