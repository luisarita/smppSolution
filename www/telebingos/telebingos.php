...
class telebingo {
 ...
 function printVisibleFrame(){
  ...
  if ( $revelados <= 1) $html .= "number1.style.visibility = (show) ? 'visible' : 'hidden'; ";
  if ( $revelados <= 2) $html .= "number2.style.visibility = (show) ? 'visible' : 'hidden'; ";
  if ( $revelados <= 3) $html .= "number3.style.visibility = (show) ? 'visible' : 'hidden'; ";
  if ( $revelados <= 4) $html .= "number4.style.visibility = (show) ? 'visible' : 'hidden'; ";
  $html .= "
      show = !show;
     }
    </script>";
