...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dgDatos.CaptionText = "Trivias Existentes"
        ...
        Me.Name = "consTrivias"
        Me.pTitle = "Consultar Trivias"
        Me.Text = "Consultar Trivias"
...
#End Region
    ...
    Private Sub cmdEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEliminar.Click
        If MsgBox("¿Seguro que desea eliminar esta trivia?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            Dim row As DataRow = row_actual(dgDatos)
            ...
            Using deleteCMD As New MySqlCommand("DELETE FROM TRIVIAS WHERE id=" & row("id"), CNX)
                Try
    ...
    Sub cargar()
        ...
        Using selectCMD As New MySqlCommand("SELECT id,nombre,numero FROM TRIVIAS")
