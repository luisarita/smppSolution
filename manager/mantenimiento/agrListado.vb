...
#Region " Windows Form Designer generated code "
    ...
    Sub New(ByVal id As Integer)
        ...
        fncListboxMySQL.popularMySQL(CObj(cbNumeros), "numeros", "numero", "numero", CNX)
        vID = id
        pTitle = "Modificar Listado"
        cmdCrear.Text = "Modificar"
        If CNX.State <> ConnectionState.Open Then CNX.Open()
        Dim dr As MySqlDataReader = New MySqlCommand("SELECT nombre,usuario,clave,numero FROM LISTADOS WHERE id=" & id, CNX).ExecuteReader
        If dr.Read Then
            ...
            dr.Close()
            fncListboxMySQL.popularMySQL(CObj(lbclaves), "claves", "id", "clave", CNX, "idListado=" & vID)
        Else
            dr.Close()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdPanel.Location = New System.Drawing.Point(0, 359)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(407, 184)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(9, 256)
        ...
        Me.Name = "agrListado"
        Me.pTitle = "Crear Listado"
        Me.Text = "Crear Listado"
...
#End Region
    ...
    Function validar() As Boolean
        ...
        ElseIf nombre.Text = "" Then
            ErrorProvider.SetError(nombre, "Debe ingresar un nombre para identificar el listado")
    ...
    Function agregar() As Boolean
        ...
        If vID = -1 Then
            strCMD = "INSERT INTO LISTADOS (numero,nombre,usuario,clave,logo_tipo,logo_archivo) VALUES ('" & numero & "','" & nombre.Text & "','" & usuario.Text & "','" & clave.Text & "','" & tipo & "',@logo_archivo)"
        Else
            strCMD = "UPDATE LISTADOS SET numero='" & numero & "',nombre='" & nombre.Text & "',usuario='" & usuario.Text & "',clave='" & clave.Text & "'"
            If useLogo Then strCMD &= ",logo_tipo='" & tipo & "',logo_archivo=@logo_archivo"
            strCMD &= " WHERE id = " & vID
        End If
        Dim strCMD2 As String = "INSERT INTO claves (clave,idListado) VALUES"
        ...
        Try
            cmd.ExecuteNonQuery()
            If vID = -1 Then
                Dim dr As Integer = New MySqlCommand("SELECT id FROM LISTADOS WHERE nombre='" & nombre.Text & "'", CNX).ExecuteScalar
                'If dr.Read Then
                vID = dr
                'End If
                'dr.Close()
